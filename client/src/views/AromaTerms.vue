<template>
  <div>
    ...
    <h1 id="top">Aroma Terminology</h1>

    <div class="no-print">
      (source: <LinkOutbound to="https://belleairecreations.com/fragrance-terminology-guide/">Belle Aire Creations</LinkOutbound>)
    </div>

    <div class="aroma-terminology">
      <div class="term-refs no-print">
        <router-link class="action button" to="#term-a">A</router-link>
        <router-link class="action button" to="#term-b">B</router-link>
        <router-link class="action button" to="#term-c">C</router-link>
        <router-link class="action button" to="#term-d">D</router-link>
        <router-link class="action button" to="#term-e">E</router-link>
        <router-link class="action button" to="#term-f">F</router-link>
        <router-link class="action button" to="#term-g">G</router-link>
        <router-link class="action button" to="#term-h">H</router-link>
        <router-link class="action button" to="#term-i">I</router-link>
        <span class="action button inactive no-term">J</span>
        <span class="action button inactive no-term">K</span>
        <router-link class="action button" to="#term-l">L</router-link>
        <router-link class="action button" to="#term-m">M</router-link>
        <router-link class="action button" to="#term-n">N</router-link>
        <router-link class="action button" to="#term-o">O</router-link>
        <router-link class="action button" to="#term-p">P</router-link>
        <span class="action button inactive no-term">Q</span>
        <router-link class="action button" to="#term-r">R</router-link>
        <router-link class="action button" to="#term-s">S</router-link>
        <router-link class="action button" to="#term-t">T</router-link>
        <router-link class="action button" to="#term-u">U</router-link>
        <router-link class="action button" to="#term-v">V</router-link>
        <router-link class="action button" to="#term-w">W</router-link>
        <span class="action button inactive no-term">X</span>
        <span class="action button inactive no-term">Y</span>
        <span class="action button inactive no-term">Z</span>
      </div>
      ...
      <dl>
        ...
        <dt>
          <span class="aroma-group">ALDEHYDIC</span>
        </dt>
        <dd>
          This is often referred to as the “modern” group since at one time the various aliphatic aldehydes used to create this group were actually “modern” in the time sense of the word. Basically, an aldehydic fragrance may be one to which aldehydes have been added because of their brilliance and incisive effect. Characteristics of all aldehydic fragrances are their brilliant and exciting top note. The classic examples of this would be <a href="https://www.fragrancex.com/products/_cid_perfume-am-lid_c-am-pid_61w__products.html"><span class="fragrance">Chanel #5</span></a> and <span class="fragrance">White Linen</span>.
        </dd>
        <dt>
          AMBER
        </dt>
      ...
      <dl>
        ...
        <dd>
          The heart or main part of the fragrance. The characteristic note when the most volatile components have lost their dominance and all of the components of the fragrance come into play. Body in perfumery is analogous to a symphony orchestra playing with the full complements of instruments.
        </dd>
        <dt>
          BOTTOM NOTE
        </dt>
      ...
      <dl>
        ...
        <dd>
          An odor resembling camphor to some degree. The essential oil <span class="aroma">spike lavender</span> is a good example of a common aromatic material with a camphorous note.
        </dd>
        <dt>
          CHARACTER
        </dt>
        ...
        <dd>
          Most typically found in the top note of the fragrance composition and may contain: <span class="aroma">bergamot</span>, <span class="aroma">grapefruit</span>, <span class="aroma">lemon</span>, <span class="aroma">lime</span>, <span class="aroma">mandarin</span>, <span class="aroma">orange</span>, <span class="aroma">petitgrain</span>, and/or <span class="aroma">tangerine</span>.
        </dd>
        <dt>
          CLASSIC
        </dt>
        ...
        <dd>
          A term derived from the French name of the German city of Cologne, where this product was allegedly first popularized. Originally, it was the condensate from the steam distillation of a water-alcohol infusion of citrus peels (<span class="aroma">bergamot</span>, <span class="aroma">lemon</span>, <span class="aroma">orange</span>), herbs, leaves (<span class="aroma">rosemary</span>, <span class="aroma">thyme</span>, <span class="aroma">lavender</span>), and flower petals (<span class="aroma">rose</span>, <span class="aroma">orange blossom</span>). With the modern advent of a wide selection of other essential oils and synthetics, this cologne has been considerably altered.<br>
          Today, cologne is usually a diluted version of a perfume using diluted alcohol as its solvent and contains from 3-10% fragrance oil in the finished product. A less expensive fragrance oil is generally used for cologne than for perfume.<br>
        ...
        <dd>
          A compound is a completed perfume formulation ready to be used in a product such as perfume, toilet water, etc. The terms “composition” and compound are interchangeable.
        </dd>
        <dt>
          CONCRETE
        </dt>
      ...
      <dl>
        ...
        <dd>
          The peculiar aroma of fresh turned soil. It is also described as “rooty” as is exhibited in <span class="aroma">vetivert</span> oil and sometimes in <span class="aroma">patchouli</span> oil.
        </dd>
        <dt>
          ENFLEURAGE
        </dt>
      ...
      <dl>
        ...
        <dt>
          <span class="aroma-group">FLORAL</span>
        </dt>
        <dd>
          A term used to describe an accord built around a singular or multi-floral theme.
        </dd>
        <dt>
          <span class="aroma-group">FLORAL BOUQUET</span>
        </dt>
        <dd>
          This is the most general group in the categorization of perfumes. The combination of <span class="aroma">Jasmine</span>, <span class="aroma">Rose</span>, <span class="aroma">Ylang</span> and <span class="aroma">Tuberose</span>, just to name a few, play an integral part in the creation of a Floral Bouquet. Florals are combined in various ways to give different nuances to the fragrance. The use of other aromatic materials in conjunction with these floral blends is a most exciting family in today’s fragrance trends. <span class="fragrance">Joy</span>, <span class="fragrance">Anais Anais</span>, <span class="fragrance">Paris</span> and <span class="fragrance">Escape</span> are examples.
        </dd>
        <dt>
          FLOWERY
        </dt>
      ...
      <dl>
        ...
        <dd>
          A note reminiscent of fresh cut leaves, grass, stems, and certain flowers. Among the essential oils, <span class="aroma">violet leaf absolute</span> is an outstanding example of this green note.
        </dd>
        <dt>
          GUMS, RESINS, BALSAMS
        </dt>
      ...
      <dl>
        ...
        <dd>
          A fragrance note that is grassy-green, spicy and somewhat therapeutic, e.g. <span class="aroma">thyme</span>, <span class="aroma">hyssop</span>, <span class="aroma">chamomile</span>.
        </dd>
        <dt>
          HONEY
        </dt>
      ...
      <dl>
        ...
        <dd>
          A certain smokiness related to the old fashioned leather goods. In spite of its odd qualities, the leather notes (French: “cuir”) play an important part in the background of complex florals as a contrasting medium to break up monotony, as exhibited in the fragrance <span class="fragrance">Cabouchard</span>.
        </dd>
        <dt>
          LIFT
        </dt>
      ...
      <dl>
        ...
        <dd>
          The odor suggestive of the aromatic lichens, and mosses, primarily <span class="aroma">oak moss</span> and tree moss; reminiscent of forest depths.
        </dd>
        <dt>
          MUSK
        </dt>
        <dd>
          For many centuries, <span class="aroma">musk</span> (the secretion of the musk deer) has been prized for its value in perfumery. The pouch contains pod-like grains that are soft and light colored. From these the perfumer prepares a tincture that is used as a fixative. Today, synthetic musks are widely used.
        </dd>
      </dl>
      ...
      <dl>
        ...
        <dt>
          <span class="aroma-group">ORIENTAL</span>
        </dt>
        <dd>
          Heavy, sweet, animal blend with woody undertones. Typically quite diffusive and tenacious. A very important accord in perfumery, used historically in <span class="fragrance">Shalimar</span> and today’s <span class="fragrance">Obsession</span>.
        </dd>
      </dl>
      ...
      <dl>
        ...
        <dd>
          Root like stems with nodes, which grow under or along the ground. Certain perfume raw materials come from rhizome, e.g., <span class="aroma">Orris absolute</span> and <span class="aroma">ginger</span> oil.
        </dd>
        <dt>
          RICH
        </dt>
      ...
      <dl>
        ...
        <dt>
          <span class="aroma-group">SINGLE FLORALS</span>
        </dt>
        <dd>
        ...
        <dd>
          A word descriptive of a pungent or piquant fragrance. Oil of <span class="aroma">clove</span> or oil of <span class="aroma">cinnamon</span> are classic examples of spiciness in single aromatic materials. In the flower group, <span class="aroma">carnation</span> and oil of <span class="aroma">lavender</span> may be described as having spicy nuances.
        </dd>
        <dt>
          <span class="aroma-group">SPICY BOUQUET</span>
        </dt>
        <dd>
          As the name implies, this group relies on spice notes such as <span class="aroma">clove</span>, <span class="aroma">cinnamon</span>, <span class="aroma">nutmeg</span> and <span class="aroma">bay</span> for its principal notes. Spice notes are universally used in perfumery. Examples are <span class="fragrance">Pierre Cardin</span>, <span class="fragrance">Spellbound</span> and <span class="fragrance">L’Air du Temps</span>.
        </dd>
        <dt>
          STABILITY
        </dt>
        ...
        <dd>
          A fragrance impression that imparts a sensation. Natural examples include <span class="aroma">vanilla</span>, <span class="aroma">benzoin</span> and <span class="aroma">honey</span>.
        </dd>
        <dt>
          SWEET (2)
        </dt>
        <dd>
          A fragrance effect classically illustrated by the <span class="aroma">rose</span>. The rose effect is constantly used to sweeten perfume oils during the course of their design. The rose is to the perfumer as sugar is to the chef.
        </dd>
        <dt>
          SYNTHETIC
        </dt>
      ...
      <dl>
        ...
        <dd>
          These are two distinctive notes possessing great tenacity, used primarily in men’s fragrances. Their use is as important in modern perfumery as it was in the infancy of the art. Some examples in this area are <span class="fragrance">Kourous</span>, <span class="fragrance">Aramis</span>, and <span class="fragrance">Antaeus</span>.
        </dd>
        <dt>
          TOP NOTE
        </dt>
